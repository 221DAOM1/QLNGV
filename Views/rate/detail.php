            ...
            <div class="break-crumb__head">
                <div class="home">
                    <a href="#">
                        ...
                        <span class="mr_lr">&nbsp;/ Cho người tuyển dủng/ Đánh giá giúp việc&nbsp;</span>
                </div>
                <div>
                    <strong>
                        <span id="danhmuc">/ Danh sách người làm</span>
                    </strong>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-product__itemm col col-6 col-md-4 col-lg-4 col-sm-6">
                                <form action="" >
                                    ...
                                    <div class="product-imgg">
                                        <a href="?act=ratehelp&xuli=chitiethelp&id=<?=$data[$i]['maCV']?>&tk=<?=$data[$i]['maTK']?>" style="display: block;">
